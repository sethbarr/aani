...
def render(report: dict) -> str:
    ...
    lines += ["", "This DEVELOPMENT SET is one panel from one paper and is not a sample from any "
              ...
              "Under the documented conservative named-prose convention, PRIMARY has 2 author_prose "
              "and 4 table_derived species; CONTEXT has 4 author_prose and 1 table_derived. "
              "Table categories assign the latter labels; numerical signs do not. The table "
              "transcription remains visually unverified. Group/complement prose corroborates "
              "these labels. The [baseline report](recall_baseline.md) explains the convention "
