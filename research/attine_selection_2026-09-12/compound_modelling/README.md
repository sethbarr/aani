...
The additions preserve the original 149-row dataset and use IDs M001–M020: eight coumarins plus piperonyl butoxide from [Godoy2005, PDF 2–3](https://doi.org/10.1590/S0103-50532005000400031#page=2); nine numeric quinoline observations from [Biavatti2002, PDF 2–3](https://doi.org/10.1590/S0103-50532002000100010#page=2); and argentilactone plus the fungicide reference MIC from [Diaz Napal2015, PDF 3–4](https://doi.org/10.1016/J.INDCROP.2015.07.001#page=3). Paper dashes and “not tested” cells are not converted into zero inhibition. This is a targeted extension, not complete extraction of the remaining bibliography.
